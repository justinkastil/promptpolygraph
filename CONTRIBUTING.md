...
the conventions, and how changes get reviewed.
...
The extension points (see [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) §4):
...
[RESPONSIBLE_USE.md](RESPONSIBLE_USE.md). Report vulnerabilities privately per
