...
def run(*, settings: Settings | None = None, mock: bool | None = None,
        environ: Mapping[str, str] | None = None, llm_probe: Probe | None = None,
        ) -> tuple[bool, list[dict[str, str]]]:
    """Validate critical dependencies, using injectable offline probes."""
